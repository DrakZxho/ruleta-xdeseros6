let premios = [
  ...
  "X10 ESC. CORAZÓN",
  "HIERBA ÚNICA",
  "ATRAPAR DOS POKEMON DE RUTA",
  "ESC. CORAZÓN",
  "MAGIKARP",
  "BANDA FOCUS",
  "CINTA FOCUS",
  "ALEATORIO DE LA POKÉDEX",
  "SNEASEL",
  "ALTARIA",
  "HIPPOWDON",
  "PIEDRA SOLAR",
  ...
  "MASTERBALL",
  "VIDASFERA",
  "TABLA DE ARCEUS (A ELEGIR)",
  "CAMPANA ALIVIO",
  "-1 VIDA (NO CUENTA VIDA 0)",
  "TOXIESFERA",
  "CAMPANA CONCHA",
  "REV. METÁLICO",
  "LLAMASFERA",
...
function girar() {
  ...
  window.document.getElementById("texto-premio").innerText =
    objetos[num].premio;
  window.document.getElementById("imagen-premio").src =
    "img/" + objetos[num].img;
}
...
function pararRuleta() {
  ...
  window.document.getElementById("imagen-premio").classList.add("animated");
}
